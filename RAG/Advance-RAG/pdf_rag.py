...
def process_pdfs(pdf_files, embeddings):
    ...
    if prompt := st.chat_input("Enter question"):
        ...
        with st.spinner():
            if st.session_state.vectorstore:
                ...
                answer = "Please upload some PDF documents first so I can assist you based on their content. I can also provide general health information if you have any questions."
