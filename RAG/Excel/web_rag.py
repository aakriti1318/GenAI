...
def main():
    ...
    if not st.session_state['valid_user']:
        ...
        with st.chat_message("assistant"):
            st.write("Hello 👋 I'm here to provide information based on the documents you've uploaded, web pages you've shared, and general health knowledge. How can I assist you today?")
        ...
        if prompt := st.chat_input("Enter question"):
            ...
            with st.spinner():
                if st.session_state.vectorstore:
                    ...
                    answer = "Please upload some PDF or Excel documents, or provide a web page URL first so I can assist you based on their content. I can also provide general health information if you have any questions."
